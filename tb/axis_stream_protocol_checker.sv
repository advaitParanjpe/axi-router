...
module axis_stream_protocol_checker #(
  ...
  logic [OUT_PORTS-1:0] stalled_packet_q;
  ...
  always @(posedge clk) begin
    ...
    if (rst) begin
      ...
      for (o = 0; o < OUT_PORTS; o = o + 1) begin
        ...
        if (^m_axis_tlast[o] === 1'bx) $fatal(1, "checker: unknown tlast on output %0d", o);
        if (^m_axis_tdest[o] === 1'bx) $fatal(1, "checker: unknown tdest on output %0d", o);
        ...
        if (held_valid_q[o] && m_axis_tvalid[o] && !m_axis_tready[o]) begin
          ...
          if (stalled_packet_q[o] && m_axis_tlast[o]) $fatal(1, "checker: packet ended while stalled on output %0d", o);
        end
        ...
        stalled_packet_q[o] <= m_axis_tvalid[o] && !m_axis_tready[o] && !m_axis_tlast[o];
      end
    end
  end
endmodule
